...
//    private static final String projectRootPath = "D:/workspace_private/works/boot-cloud/";//更改1
     ...
     * zxcv-api 代码.
     */
    private static final String javaClassPreffixName = "SiteProductInfo";//更改3

    public static void main(String[] args) {
        String[] tableNames = new String[] {"site_product_info"};////更改4
    ...
    private static DataSourceConfig getDataSourceConfig() {
        String dbUrl
            = "jdbc:mysql://182.92.118.137:8002/zxcv?useUnicode=true&characterEncoding=UTF-8&allowMultiQueries=true";
